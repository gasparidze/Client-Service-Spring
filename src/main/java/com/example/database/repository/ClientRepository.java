...
public interface ClientRepository extends JpaRepository<Client, Integer> {
    ...
    @Query(nativeQuery = true,
            value = "SELECT * FROM client_service.client, unnest(emails) AS em " +
                    "WHERE em = :email")
    ...
    @Query(nativeQuery = true, value = """
            ...
            WHERE id = :id
            """)
    int updateClientEmails(Integer id, String email);
    ...
    @Query(nativeQuery = true, value = """
            ...
            WHERE id = :id
            """)
    int updateClientEmails(Integer id, String replacedEmail, String newEmail);
    ...
    @Query(nativeQuery = true, value = """
            ...
            WHERE id = :id
            """)
    int updateClientPhoneNumbers(Integer id, String phone);
    ...
    @Query(nativeQuery = true, value = """
            ...
            WHERE id = :id
            """)
    int updateClientPhoneNumbers(Integer id, String replacedPhone, String newPhone);
     ...
     * @param id - идентификатор клиента
     * @param email - email
     * @return int - количество удаленных email'ов
     */
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query(nativeQuery = true, value = """
            UPDATE client_service.client 
            ...
            WHERE id = :id
            """)
    int deleteClientEmail(Integer id, String email);

    /**
     * метод, удаляющий номер телефона у клиента по его id
     * @param id - идентификатор клиента
     * @param phone - номер телефона
     * @return int - количество удаленных номеров телефона
     */
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query(nativeQuery = true, value = """
            UPDATE client_service.client 
            ...
            WHERE id = :id
            """)
    int deleteClientPhone(Integer id, String phone);
     ...
     */
    Page<Client> findByFioContainingIgnoreCaseOrderByFio(Pageable pageable, String fio);
